...
### KEGG model for oversampled documents
...
f <- 'stm_oversamp_kegg_cohort_content_pooled_binary_l1_k75_624811.rds'
fit <- readRDS('~/Qiime/Children/stm_oversamp_kegg_cohort_content_pooled_binary_l1_k75_624811.rds')
...
### OTU model for oversampled documents
...
f <- 'stm_oversamp_otus_cohort_content_pooled_binary_l1_k75_940544.rds'
fit <- readRDS("~/Qiime/Children/stm_oversamp_otus_cohort_content_pooled_binary_l1_k75_940544.rds")
