...
dir_name <- paste0('~/Dropbox/stm_microbiome/data_active/AG_female/stm_s97_rarefied_supervised')
...
eff_plot <- plot.estimateEffect(eff, 'FEMALE', model=fit, topics=1:K, method='difference',cov.value1=1,cov.value2=0,width=50)
...
plot_violins2(fit,dat$meta,top_ord)
