...
hm_beta <- plot_big_heatmap(taxon_table,coef_k,zbar=FALSE,col1='cyan',col2='black',col3='orange',cexCol=1.5,cexRow=.75,main='Taxa',scale='row')
dev.off()
...
sink(file.path(heatmap_dir,'group_beta_order.txt'))
